...
--- ตั้งค่า
Config.DiscordWebHook = "https://discord.com/api/webhooks/1421363319478161478/_eDalKwdDR-W7Y5rVOahmpAC4CZNUTKpDBf-yVu__ociX42fAMZ06RpVuYd1tUuPNoh8" -- Webhook Discord

Config.Cameramodeheader = '0x4A4A78 Camera Mode' -- ชื่อด้านบนของ cameramode
Config.MaxFilterStrength = 2.6
Config.SpeedBase = 0.6        -- ความเร็วพื้นฐาน 
Config.SpeedShift = 2.2       -- ความไวตอนกด SHIFT
Config.SpeedAlt = 0.25        -- ความไวตอนกด ALT
Config.MaxCam = 25.0        -- ระยะสูงสุดที่อนุญาต ถ้าเกินจะปิด CameraMode

------ DO NOT CHANGE THIS UNLESS YOU KNOW WHAT YOU ARE DOING -------
Config.EndFOV = 20.0
Config.CameraOffsetStart = vector3(2.20, 2.0, 2.20)
Config.CameraOffsetEnd = vector3(0.0, 5.0, -0.6)
Config.CameraTransitionTime = 400
------ DO NOT CHANGE THIS UNLESS YOU KNOW WHAT YOU ARE DOING -------
